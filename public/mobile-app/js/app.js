(function() {
  ...
  window.openSocialLogin = async (platform) => {
    if (platform === 'google') {
      ...
      const popup = window.open("", "GoogleSignIn", `width=${popupWidth},height=${popupHeight},top=${top},left=${left}`);
      ...
      if (popup) {
        const popupHtml = `
          ...
          <head>
            ...
            <style>
              body { font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, sans-serif; background: #fff; display: flex; justify-content: center; align-items: center; height: 100vh; margin: 0; }
              .card { width: 100%; max-width: 360px; padding: 40px 24px; border: 1px solid #dadce0; border-radius: 8px; text-align: center; box-sizing: border-box; }
              @media(max-width: 400px) { .card { border: none; } }
              .logo { height: 24px; margin-bottom: 16px; }
              .title { font-size: 24px; font-weight: 400; color: #202124; margin-bottom: 8px; }
              .subtitle { font-size: 16px; color: #202124; margin-bottom: 24px; }
              .account-item { display: flex; align-items: center; padding: 12px; border-bottom: 1px solid #dadce0; cursor: pointer; text-align: left; }
              .account-item:hover { background: #f8f9fa; }
              .avatar { width: 36px; height: 36px; border-radius: 50%; background: #6B46C1; color: #fff; display: flex; align-items: center; justify-content: center; font-weight: bold; margin-right: 12px; flex-shrink: 0; }
          ...
          <body>
            <div class="card">
              ...
              <div class="subtitle">to continue to IESVRA</div>
              
              <div class="account-item" onclick="select('Pavan Kumar', 'pavankm7523@gmail.com')">
                <div class="avatar" style="background:#6B46C1;">P</div>
                <div>
                  <div class="name">Pavan Kumar</div>
                  <div class="email">pavankm7523@gmail.com</div>
                </div>
              </div>
              
              <div class="account-item" onclick="select('Guest User', 'guest@iesvra.com')">
                <div class="avatar" style="background:#4A5568;">G</div>
                <div>
                  <div class="name">Guest User</div>
                  <div class="email">guest@iesvra.com</div>
                </div>
              </div>
            </div>

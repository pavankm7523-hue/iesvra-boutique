      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
        ...
        <div>
          ...
          <ul className="space-y-3.5 text-sm">
            ...
            <li>
              <a href="/mobile-app/index.html" className="hover:text-gold transition-colors">Mobile App</a>
            </li>
          </ul>
        </div>
        ...
        <div>
          ...
          <div className="space-y-2 text-sm text-white/70">
            ...
            <p className="flex items-center gap-2">
              ...
              <a href="tel:+917061333200" className="hover:text-gold transition-colors">+91 70613 33200</a>
            </p>
          </div>
        </div>

...
export function LiveActivityTicker() {
  ...
  return (
    <div className="w-full bg-gradient-to-r from-purple-950 via-slate-900 to-indigo-950 text-white border-y border-purple-500/20 py-2.5 px-4 shadow-inner overflow-hidden select-none">
      <div className="max-w-7xl mx-auto flex items-center justify-between gap-4 text-xs">
        ...
        <div className="flex items-center gap-2 shrink-0">
          ...
          <span className="font-extrabold tracking-wider uppercase text-[10px] text-emerald-400 bg-emerald-950/80 border border-emerald-500/30 px-2 py-0.5 rounded-full">
            LIVE ACTIVITY
          </span>
        </div>
        ...
        <div className="flex-1 flex items-center justify-center min-w-0">
          <div
            className={`flex items-center gap-2.5 transition-all duration-300 transform ${
        ...
        {/* Right Location Tag */}
        <div className="hidden md:flex items-center gap-1.5 text-purple-200/80 text-[11px] font-semibold shrink-0 bg-white/5 border border-white/10 px-2.5 py-1 rounded-full">

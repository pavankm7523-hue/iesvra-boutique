          ...
          <>
            ...
            <div className="grid grid-cols-2 gap-3">
              <button
                ...
                className="flex items-center justify-center gap-2 h-11 border border-border rounded-md hover:bg-secondary/10 transition font-medium text-sm text-navy-deep active:scale-95 cursor-pointer"
              >
